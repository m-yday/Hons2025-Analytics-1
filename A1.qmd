...
The optimal values are: `alpha` = `r opt_alpha`, `lambda` = `r opt_lambda`. The resulting minimum cross-validation error is `cvmin` = `r cvmin`. We choose these values for alpha and lambda.
