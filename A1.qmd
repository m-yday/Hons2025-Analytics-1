...
Our elasticnet regularisation has selected an alpha value of 1, which corresponds to Ridge Regression. This makes sense because our original model had many variables, with few of them appearing significant in the saturated model.
