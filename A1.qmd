...
minlossplot(elasticnet, ylim=c(0.586, 0.606), main="CV Loss plot using minimum CV loss", cv.type="min")
minlossplot(elasticnet, ylim=c(0.586, 0.606), main="CV Loss plot using CV loss within 1 standard error of the minimum", cv.type="1se")
```
